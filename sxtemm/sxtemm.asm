                PAGE    90,132
                NAME    SXTEMM
                include SXTEMM.MAC       ; macros
                include SXTEMM.INC       ; structures
;
;************************************************************************
;*                                                                      *
;*      EMS 4.0 Driver for C&T Super XT chipset, rev.01, Oct-21         *
;*                                                                      *
...
;--------------------------------------------------------------------
emsio           LABEL   WORD
ems_io          DW      208h            ;EMS i/o port address
...
ramch14:
                ...
                CMP     CX, 3
                JZ      sub4h
                ADD     BX,0C000h               ;EMS page registers are at offset 0000, 8000, 4000, C000 on the Super XT
sub4h:          SUB     BX,4000h
                LOOP    ramch14
...
;--------------------------------------------------------------------
start_msg       db      CR,LF
                DB      'SXTEMM: C&T Super XT EMM Driver '
msg_ver         db      'r01'
                DB      CR,LF,'$'
...
tstpage         DB      '0000',CR,'$'
info_msg        db       CR,LF
                db      'Expanded Memory Manager for the C&T Super XT chipset.',CR,LF
                db       CR,LF
                db      'Based on original works (c) 2014, Lo-Tech and (c) 1988, Alex Tsourikov.',CR,LF
                db       CR,LF
                db      'Syntax:    DEVICE=SXTEMM.EXE [/switches]',CR,LF
                db       CR,LF
                db      '  /p:nnnn - Page frame address(D000)',CR,LF
                db      '  /i:nnn  - EMS i/o port base address(208)',CR,LF
