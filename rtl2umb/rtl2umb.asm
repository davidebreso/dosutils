...
; By Davide Bresolin
;
; based on Eudimorphodon's ems2umb.asm, originally based on skeleton code
; found on pastebin.com (https://pastebin.com/w2Dh5SNZ)
;
...
;       wasm rtl2umb.asm
;       wlink system dos file rtl2umb.o
;
...
interrupt proc
        ...
        mov     ds, ax
        les     di, dword ptr cs:db_ptr     ; Data block address after ES:DI
...
sys_start   proc
            disp_str dd_msg
            les     bx, cs:[db_ptr] ; set ES:BX to device request header
...
exe_start   proc
            ...
            mov     ax, @data       ; point DS at the code segment
            mov     ds, ax
            disp_str exe_msg
